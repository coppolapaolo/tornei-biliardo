...
| `is_fittizio` | BOOLEAN | NO |  | False |  |
| `prova_gara_id` | INTEGER | YES |  |  |  |
| `prova_campionato_id` | INTEGER | YES |  |  |  |
...
| `is_prova` | BOOLEAN | NO |  | False |  |
| `prova_expires_at` | DATETIME | YES |  |  |  |
| `prova_avviso_inviato_at` | DATETIME | YES |  |  |  |
...
| `played_on_table` | VARCHAR(10) | YES |  |  |  |
...
**Constraints:**
- UNIQUE(challenge_id, axis, value)
...
| `corpo` | TEXT | NO |  |  |  |
| `contesto` | TEXT | YES |  |  |  |
| `stato` | VARCHAR(20) | NO |  | ricevuta |  |
| `stato_cambiato_il` | DATETIME | YES |  |  |  |
| `nota_pubblica` | TEXT | YES |  |  |  |
| `issue_number` | INTEGER | YES |  |  |  |
| `tentativi_invio` | INTEGER | NO |  | 0 |  |
| `ultimo_errore` | VARCHAR(500) | YES |  |  |  |
| `created_at` | DATETIME | NO |  | func |  |
| `updated_at` | DATETIME | NO |  | func |  |
...
|--------|------|----------|-----|---------|-------------|
| `id` | INTEGER | NO | PK |  |  |
| `ultimo_controllo` | DATETIME | YES |  |  |  |
| `etag` | VARCHAR(200) | YES |  |  |  |
| `created_at` | DATETIME | NO |  | func |  |
| `updated_at` | DATETIME | NO |  | func |  |
...
| `id` | INTEGER | NO | PK |  |  |
| `match_id` | INTEGER | NO | FK→match.id |  |  |
| `corrected_by_id` | INTEGER | NO | FK→user.id |  |  |
| `previous_player1_score` | INTEGER | YES |  |  |  |
| `previous_player2_score` | INTEGER | YES |  |  |  |
| `previous_status` | VARCHAR(30) | YES |  |  |  |
| `new_player1_score` | INTEGER | NO |  |  |  |
| `new_player2_score` | INTEGER | NO |  |  |  |
| `previous_player3_score` | INTEGER | YES |  |  |  |
| `new_player3_score` | INTEGER | YES |  |  |  |
| `previous_detail` | VARCHAR(120) | YES |  |  |  |
| `new_detail` | VARCHAR(120) | YES |  |  |  |
