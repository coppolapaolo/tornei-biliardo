...
from gen_confronto import (  # noqa: E402
    CARD_GARA4, CARD_SFIDA, INSET_GARA_VIVA, INSET_PARTITA, INSET_PLAYOFF,
    G_HEAD, D_HEAD, NAV_GIOC, NAV_DIR, card_campionato, card_gara3,
    card_gara_dir, screen, sez, DIRIGI, ISCRITTO,
)
from gen_ospite import (  # noqa: E402
    CAMPIONATO as CAMPIONATO_PUB, IN_ARRIVO, aperte, BTN_ISCRIVITI, BTN_ATTESA,
    NOTA_ACCOUNT, head as head_ospite, sez as sez_ospite, screen as screen_ospite,
)
...
FEEDBACK = re.search(r'    <section class="c7-feedback">.*?\n    </section>\n',
                     _MAIN, re.S).group(0)
...
primo = (FEEDBACK
         + sez("Le tue gare",
               card_gara3(GIOCA_GARA, insets=INSET_PARTITA + INSET_GARA_VIVA), "1")
...
nuovo = (SETUP
         + sez("Le tue gare",
               vuoto("target", "Non sei iscritto a nessuna gara",
...
def inset_x(esercizio=True):
    if esercizio:
        azione = ('          <span class="btn btn-primary btn-sm btn-w" style="margin-top:12px">'
                  '<svg viewBox="0 0 24 24" class="ico ico-sm"><use href="#i-play"></use></svg>'
                  'Gioca l’esercizio</span>\n')
        coda = ""
    else:
        azione = ""
        coda = ('          <div class="meta" style="margin-top:10px">Il direttore non ha ancora '
...
M_X1 = ('Campionato Sociale 2026 <span class="c7-sep">&middot;</span> Palla 8 '
        '<span class="c7-sep">&middot;</span> <span class="c7-num">30/08</span> '
        '<span class="c7-sep">&middot;</span> Biliardo Club Udine')
M_X2 = ('Gara singola <span class="c7-sep">&middot;</span> Palla 9 '
...
ics = (sez("Le tue gare",
           ...
           + card_gara_x("Coppa del Venerdì", M_X2, "2/4", "9", False, ""), "2")
       + sez("Aperte, puoi iscriverti", CARD_GARA4, "1")
       + sez("Campionati", card_campionato(), "1 attivo", "Vedi tutti"))
...
PODIO = '''        <div class="inset">
          ...
          <div class="podium" style="margin-top:8px">
            <div>
              <div class="c7-num" style="font-size:11px;color:var(--c7-ink-muted)">1&deg;</div>
              <div class="trunc" style="margin-top:2px;font-size:12px;font-weight:800">Elena Furlan</div>
            </div>
            <div>
              <div class="c7-num" style="font-size:11px;color:var(--c7-ink-muted)">2&deg;</div>
              <div class="trunc" style="margin-top:2px;font-size:12px;font-weight:800">Marco Bassi</div>
            </div>
            <div>
              <div class="c7-num" style="font-size:11px;color:var(--c7-ink-muted)">3&deg;</div>
              <div class="trunc" style="margin-top:2px;font-size:12px;font-weight:800">Luca Berti</div>
            </div>
          </div>
          <div class="meta" style="margin-top:10px">Sei arrivato <span class="c7-num" style="color:var(--c7-ink)">2&deg;</span> su <span class="c7-num">14</span> <span class="c7-sep">&middot;</span> <span class="c7-num">9</span> vittorie su <span class="c7-num">13</span></div>
        </div>
'''
        ...
        <div class="inset" style="background:var(--c7-card)">
          ...
          <div class="c7-rows" style="margin-top:4px">
            ...
            <div class="c7-rows__row" style="border-color:var(--c7-line)">
              ...
              <span class="fill trunc" style="font-size:13px;font-weight:800;color:var(--c7-ink)">marco &mdash; sei tu</span>
...
concluse = (sez("Le tue gare", CARD_CONCLUSA, "1 conclusa")
            + sez("Aperte, puoi iscriverti", CARD_GARA4, "1")
            + sez("Campionati", CAMPIONATO_FINITO, "1 concluso", "Vedi tutti"))

# ── 6. Direttore senza gare ──────────────────────────────────────────────────
AZIONI_DIR = ('        <div class="c7-empty__actions">\n'
              '          <span class="btn btn-primary">Crea la prima gara</span>\n'
              '        </div>\n')

dir_vuoto = (sez("Le tue gare",
                 vuoto("flag", "Non dirigi ancora nessuna gara",
...
# ── 7-8. Ospite ──────────────────────────────────────────────────────────────
ospite_quieto = (sez_ospite("Iscrizioni aperte",
                            aperte(BTN_ISCRIVITI, NOTA_ACCOUNT, BTN_ATTESA), "2")
...
AZ_ESCI = ('        <div style="display:flex;gap:8px">\n'
           ...
           '        </div>\n')
AZ_ENTRA = ('        <div style="display:flex;gap:8px">\n'
            '          <span class="btn btn-secondary btn-sm btn-fill">Dettagli</span>\n'
...
attesa = (sez("Le tue gare",
              card_attesa("Torneo del Giovedì",
                          ...
                          inset_attesa("La gara è al completo",
              ...
              + card_attesa("Coppa del Venerdì",
                            ...
                            inset_attesa("Serve un numero pari",
                            ...
                            AZ_ESCI), "2")
          + sez("Aperte, puoi iscriverti",
                card_attesa("Gara 4 &mdash; Palla 9",
...
senza_tavolo = (sez("Le tue gare",
                    card_attesa("Gara 3 &mdash; Palla 8",
...
if __name__ == "__main__":
    giocatore = [("CasoPrimoAccesso", primo), ("CasoNuovo", nuovo),
                 ("CasoVuoto", vuoto_tot), ("CasoX", ics), ("CasoConcluse", concluse),
                 ("CasoListaAttesa", attesa), ("CasoSenzaTavolo", senza_tavolo)]
    for nome, corpo in giocatore:
        (OUT / f"{nome}.body").write_text(screen(G_HEAD, corpo, NAV_GIOC), encoding="utf-8")
        print("scritto", nome)
    ...
    for nome, corpo in [("CasoOspiteQuieto", ospite_quieto),
