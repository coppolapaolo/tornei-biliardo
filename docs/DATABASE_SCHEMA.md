...
> Last updated: 2026-01-23 15:02 UTC
>
...
| `discipline` | VARCHAR(20) | YES |  | palla_8 |  |
| `player1_score` | INTEGER | YES |  | 0 |  |
| `player2_score` | INTEGER | YES |  | 0 |  |
| `winner_id` | INTEGER | YES | FK→user.id |  |  |
| `status` | VARCHAR(20) | YES |  | pending |  |
...
| `name` | VARCHAR(100) | NO |  |  |  |
| `description` | TEXT | YES |  |  |  |
| `director_id` | INTEGER | NO | FK→user.id |  |  |
| `grading_criteria` | TEXT | NO |  |  |  |
| `is_active` | BOOLEAN | NO |  | True |  |
...
| `discipline` | VARCHAR(50) | NO |  | palla_8 |  |
| `distance` | INTEGER | NO |  | 5 |  |
| `is_race_to` | BOOLEAN | NO |  | True |  |
...
| `preferred_days` | VARCHAR(20) | YES |  |  |  |
| `preferred_times` | VARCHAR(50) | YES |  |  |  |
| `created_at` | DATETIME | NO |  | func |  |
| `updated_at` | DATETIME | NO |  | func |  |
...
| `id` | INTEGER | NO | PK |  |  |
| `user_id` | INTEGER | NO | FK→user.id |  |  |
| `category` | VARCHAR(1) | NO |  |  |  |
| `assigned_by_id` | INTEGER | YES | FK→user.id |  |  |
| `assigned_at` | DATETIME | NO |  | func |  |
...
| `description` | TEXT | YES |  |  |  |
| `is_active` | BOOLEAN | NO |  | True |  |
| `applies_to_campionatos` | BOOLEAN | NO |  | True |  |
| `applies_to_individual_matches` | BOOLEAN | NO |  | True |  |
| `created_at` | DATETIME | NO |  | func |  |
| `updated_at` | DATETIME | NO |  | func |  |
...
| `higher_category` | VARCHAR(1) | NO |  |  |  |
| `lower_category` | VARCHAR(1) | NO |  |  |  |
| `handicap_value` | INTEGER | NO |  |  |  |
| `created_at` | DATETIME | NO |  | func |  |
| `updated_at` | DATETIME | NO |  | func |  |

**Constraints:**
- UNIQUE(rule_id, higher_category, lower_category)

**Foreign Keys:**
- `rule_id` → `handicap_rule.id` (ON DELETE CASCADE)
...
| `max_handicap` | INTEGER | YES |  |  |  |
| `created_at` | DATETIME | NO |  | func |  |
| `updated_at` | DATETIME | NO |  | func |  |

**Constraints:**
- UNIQUE(rule_id, rating_system)
...
| `id` | INTEGER | NO | PK |  |  |
| `user_id` | INTEGER | NO | FK→user.id |  |  |
| `notification_type` | VARCHAR(23) | NO |  |  |  |
...
|--------|------|----------|-----|---------|-------------|
| `id` | INTEGER | NO | PK |  |  |
| `notification_type` | VARCHAR(23) | NO | UQ |  |  |
