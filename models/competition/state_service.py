...
class StateService:
    ...
    setup ← inscription (reopen_setup)

    Transaction Management:
    All state transitions use @transactional(domain="competition") ensuring
    atomic state changes with automatic rollback on validation failures.
    """
