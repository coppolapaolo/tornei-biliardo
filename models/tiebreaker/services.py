...
class TiebreakerService:
    ...
    def record_rally_attempt(
        ...
        rally_attempt = RallyAttempt(
            ...
            was_successful=points_scored > 0,
    ...
    def complete_playoff_match(
        ...
        playoff_match = PlayoffMatch.query.get_or_404(playoff_match_id)
    ...
    def get_tiebreaker_status(tiebreaker_id: int) -> Dict[str, Any]:
        ...
        if tiebreaker.tiebreaker_type == TiebreakerType.SPOT_SHOT.value:
            status["spot_shots"] = [
                {
        ...
        elif tiebreaker.tiebreaker_type == TiebreakerType.RALLY.value:
        ...
        elif tiebreaker.tiebreaker_type == TiebreakerType.PLAYOFF_MATCH.value:
...
class TiebreakerConfigurationService:
    ...
    def get_tiebreaker_type_for_discipline(
        discipline: str,
        configuration: Optional[TiebreakerConfiguration] = None
    ) -> TiebreakerType:
