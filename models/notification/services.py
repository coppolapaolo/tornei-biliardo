...
class NotificationService:
    ...
    def create_notification(
        ...
        if not NotificationPreference.is_notification_enabled(user_id, notification_type):
            return None
        
        preference = NotificationPreference.get_user_preference(user_id, notification_type)
    ...
    @staticmethod
    def notify_match_proposal(proposer_id: int, target_user_id: int, match_details: Dict[str, Any]) -> Optional[Notification]:
    ...
    @staticmethod
    def notify_match_accepted(proposer_id: int, accepter_name: str, match_details: Dict[str, Any]) -> Optional[Notification]:
    ...
    @staticmethod
    def notify_tournament_registration(user_ids: List[int], tournament_name: str, tournament_id: int) -> List[Notification]:
    ...
    @staticmethod
    def notify_playoff_invitation(user_id: int, playoff_name: str, tournament_name: str, deadline: datetime) -> Optional[Notification]:
        ...
        for template_data in templates_data:
            ...
            if not existing:
                template = NotificationTemplate(
                    ...
                    default_priority=template_data.get("priority", NotificationPriority.NORMAL),
