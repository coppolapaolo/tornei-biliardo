...
class KpiNotificationService:
    ...
    I testi sono pigri (ADR-062): ogni admin li legge nella sua lingua, anche
    se l'avviso nasce da uno scheduled task.
    """
    ...
    def notify_milestone(milestone_type: MilestoneType, value: int) -> List[int]:
        ...
        if milestone_type == MilestoneType.USERS_TOTAL:
            title = _l("Milestone: %(value)s utenti!", value=value)
            message = _l(
            ...
            title = _l("Milestone: %(value)s partite!", value=value)
            message = _l(
            ...
            title = _l("Milestone: %(value)s gare completate!", value=value)
            message = _l(
                "Sono state completate %(value)s gare. " "Ottimo lavoro!",
                value=value,
            )
        else:
            title = _l("Milestone raggiunta!")
            message = _l(
    ...
    def notify_activity_alert(alert_type: AlertType) -> List[int]:
        ...
        if alert_type == AlertType.NO_MATCH_3_DAYS:
            title = _l("Attenzione: calo attivita")
            message = _l(
            ...
            title = _l("Attenzione: nessuna partita da 7 giorni")
            message = _l(
            ...
            title = _l("Attenzione: nessuna registrazione")
            message = _l(
            ...
            title = _l("Alert attivita")
            message = _l("Si e verificato un calo di attivita sulla piattaforma.")
            priority = NotificationPriority.NORMAL
