...
def debug_challenge_images():
    ...
    with create_app().app_context():
        ...
        try:
            ...
            print(f"\n💡 Suggerimenti:")
            print(f"   1. Se image_path esiste ma file non c'è: rimuovere image_path dal database")
            print(f"   2. Se image_filename esiste ma file non c'è: rimuovere image_path dal database") 
            ...
            for challenge in challenges:
                if challenge.image_path:
                    ...
                    if not os.path.exists(expected_path):
                        print(f"   Rimosso image_path rotto per challenge {challenge.id}")
