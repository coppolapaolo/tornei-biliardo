...
class TestVenueFormNoneValues:
    ...
    def test_venue_form_renders_empty_strings_not_none(self, client, admin_user, venue_with_none_values):
    ...
    def test_admin_can_access_inactive_venue(self, client, admin_user, venue_with_none_values):
    ...
    def test_regular_user_cannot_access_inactive_venue(self, client, regular_user, venue_with_none_values):
    ...
    def test_venue_list_shows_inactive_venues_for_admin(self, client, admin_user, venue_with_none_values):
        ...
        assert ("Attiva" in content and "button" in content) or "fas fa-check" in content

    def test_admin_can_activate_inactive_venue(self, client, admin_user, venue_with_none_values):
    ...
    def test_ajax_toggle_venue_status(self, client, admin_user, venue_with_none_values):
        ...
        response = client.post(f'/admin/venues/{venue_with_none_values.id}/toggle',
...
class TestVenueCreationFromCombo:
    ...
    def test_venue_form_handles_missing_number_of_tables(self, client, admin_user):
        ...
        if created_venue:
            assert created_venue.number_of_tables is None or created_venue.number_of_tables == 0