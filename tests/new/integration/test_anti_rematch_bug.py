...
class TestAntiRematchBug:
    ...
    def test_anti_rematch_should_prevent_immediate_rematches(self, admin_user, test_players, db_session):
        ...
        for round_num in range(1, 4):  # 3 turni
            ...
            all_encounters = db_session.query(PlayerEncounter).filter_by(gara_id=gara.id).all()
    ...
    def _complete_all_matches_controlled(self, matches: List[Match], db_session):
        ...
        for i, match in enumerate(matches):
            ...
            other_player_id = match.player2_id if winner_id == match.player1_id else match.player1_id
    ...
    def _find_previous_encounter(self, gara_id: int, p1_id: int, p2_id: int, current_round: int) -> int:
    ...
    def test_anti_rematch_with_limited_options(self, admin_user, test_players, db_session):
        ...
        for i in range(len(pairings_by_round) - 1):
            ...
            immediate_rematches = current_round_pairings.intersection(next_round_pairings)
