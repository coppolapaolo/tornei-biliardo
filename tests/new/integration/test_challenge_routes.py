...
class TestChallengeRoutes:
    ...
    def test_create_challenge_post(self, client, director_user):
        ...
        response = client.post('/challenge/create', data={
    ...
    def test_edit_challenge_post(self, client, director_user, test_challenge):
        ...
        response = client.post(f'/challenge/{test_challenge.id}/edit', data={
    ...
    def test_edit_challenge_requires_permission(self, client, player_user, test_challenge):
    ...
    def test_delete_challenge_requires_permission(self, client, player_user, test_challenge):
...
class TestChallengeAttemptRoutes:
    ...
    def test_complete_attempt_score(self, client, player_user, test_attempt):
        ...
        response = client.post(f'/challenge/attempt/{test_attempt.id}/complete', data={
            'score': '85',
            'notes': 'Good attempt'
        })
    ...
    def test_complete_attempt_pass_fail(self, client, player_user, app):
        ...
        with app.app_context():
            ...
            response = client.post(f'/challenge/attempt/{attempt.id}/complete', data={
                'passed': 'true',
    ...
    def test_complete_attempt_access_control(self, client, app, test_attempt):
        ...
        with app.app_context():
            ...
            # Should be forbidden
            assert response.status_code in [403, 404]  # Depending on security implementation
