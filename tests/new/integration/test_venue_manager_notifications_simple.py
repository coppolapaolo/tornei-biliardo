...
def test_director_venue_manager_request_creates_admin_notification(app, client):
    ...
    with app.app_context():
        ...
        director = User(username="test_director", email="director@test.com", role="director")
...
def test_admin_rejection_notifies_requester(app, client):
    ...
    with app.app_context():
        ...
        # Create test users
        admin = User(username="test_admin_reject", email="admin_reject@test.com", role="admin")
        admin.set_password("password")
        db.session.add(admin)
        
        player = User(username="test_player_reject", email="player_reject@test.com", role="player")
        player.set_password("password")
        db.session.add(player)
...
def test_admin_approval_notifies_requester(app, client):
    ...
    with app.app_context():
        ...
        # Create test users
        admin = User(username="test_admin_approve", email="admin_approve@test.com", role="admin")
        admin.set_password("password")
        db.session.add(admin)
        
        player = User(username="test_player_approve", email="player_approve@test.com", role="player")
        player.set_password("password")
        db.session.add(player)
...
def test_web_request_integration(app, client):
    ...
    with app.app_context():
        ...
        # Create test users
        admin = User(username="test_admin_web", email="admin_web@test.com", role="admin")
        admin.set_password("password")
        db.session.add(admin)
        
        player = User(username="test_player_web", email="player_web@test.com", role="player")
        player.set_password("password")
        db.session.add(player)
