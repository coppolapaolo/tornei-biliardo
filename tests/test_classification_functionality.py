...
def test_player_encounter_functionality(app):
    ...
    with app.app_context():
        # Create test data
        tournament = Tournament(name="Test Tournament", tournament_type="Amalfi", is_active=True)
...
def test_round_classification_functionality(app):
    ...
    with app.app_context():
        ...
        progression = RoundClassificationService.get_player_progression(prova.id, players[0].id)
...
def test_tournament_classification_functionality(app):
    ...
    with app.app_context():
        ...
        classifications = ClassificationService.update_tournament_classification(tournament.id)
        ...
        player_rank = ClassificationService.get_player_ranking(tournament.id, players[0].id)
