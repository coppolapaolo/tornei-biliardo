...
class TestUserDeletion:
    ...
    def test_delete_user_with_relationships(self, db_session):
        ...
        # (Note: The actual handling of relationships depends on your foreign key constraints)
        user.delete()
...
class TestUserUtilityMethods:
    ...
    def test_find_all_class_method(self, db_session):
        ...
        assert len(all_users) >= 2  # At least our two users (might be more from other tests)
