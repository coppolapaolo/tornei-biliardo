...
class TestRackService:
    ...
    @patch('models.match.services.Rack')
    @patch('models.match.services.db')
    def test_add_rack_with_score_update_player1_wins(self, mock_db, mock_rack_class, mock_add_rack):
        ...
        mock_rack_class.query.filter_by.return_value.order_by.return_value.first.return_value = mock_last_rack
    ...
    @patch('models.match.services.Rack')
    @patch('models.match.services.db')
    def test_add_rack_with_score_update_player2_wins(self, mock_db, mock_rack_class, mock_add_rack):
        ...
        # No previous racks
        mock_rack_class.query.filter_by.return_value.order_by.return_value.first.return_value = None
    ...
    @patch('models.match.services.Rack')
    @patch('models.match.services.db')
    def test_add_rack_with_score_update_match_finished(self, mock_db, mock_rack_class, mock_add_rack, mock_result_service):
    ...
    @patch('models.match.services.Rack')
    @patch('models.match.services.db')
    def test_set_match_result_direct_best_of(self, mock_db, mock_rack_class, mock_add_rack):
        ...
        mock_rack_class.query.filter_by.return_value.all.return_value = mock_existing_racks
...
class TestMatchResultService:
    ...
    def test_submit_result_success(self, mock_db):
        ...
        assert mock_match.winner_id == 456
        mock_db.session.add.assert_called_once_with(mock_match)
        assert mock_db.session.commit.call_count == 2  # Once for setting winner, once for transition
    ...
    def test_submit_result_invalid_winner(self, mock_db):
        ...
        with pytest.raises(ValueError, match="winner_id non appartiene ai giocatori del match"):
