...
class TestN1Problem:
    ...
    def test_n1_problem_initialization(self):
        ...
        problem = N1Problem(
            ...
            child_queries=["SELECT * FROM orders WHERE user_id = 1", "SELECT * FROM orders WHERE user_id = 2"],
...
class TestQueryAnalyzer:
    ...
    def test_detect_n1_problems_with_problems(self, analyzer):
        ...
        child_metrics = QueryMetrics("child_hash", "SELECT * FROM orders WHERE user_id = ?")
    ...
    def test_get_optimization_suggestions_with_suggestions(self, mock_generate, analyzer):
    ...
    def test_generate_optimization_suggestion_index(self, analyzer):
        ...
        metrics = QueryMetrics("hash1", "SELECT * FROM users WHERE id = 1 ORDER BY name")
...
class TestQueryOptimizer:
    ...
    def test_get_optimization_recommendations(self, mock_suggestions, mock_n1, optimizer):
        ...
        critical_rec = next((r for r in recommendations if r["priority"] == "critical"), None)
...
class TestBulkLoadRelationships:
    ...
    def test_bulk_load_relationships_basic(self):
        ...
        mock_relationship._sa_class_manager = Mock()  # Make it look like SQLAlchemy attribute
