...
class TestUserService:
    ...
    def test_create_user_success(self, mock_user_class, mock_db):
        ...
        mock_user_class.query.filter_by.return_value.filter.return_value.count.return_value = 0
    ...
    def test_create_user_admin_already_exists(self, mock_user_class):
        ...
        mock_user_class.query.filter_by.return_value.filter.return_value.count.return_value = 1
    ...
    def test_update_user_username_conflict(self, mock_user_class, mock_db):
        ...
        mock_user_class.query.filter.return_value.first.return_value = mock_conflicting_user
    ...
    def test_request_director_promotion_success(self, mock_request_class, mock_db):
        ...
        mock_request_class.assert_called_once_with(user_id=123, notes="I want to be director")
    ...
    @patch('models.user.services.DirectorRequest')
    @patch('models.user.services.db')
    def test_request_director_promotion_pending_exists(self, mock_db, mock_request_class):
        ...
        mock_request_class.query.filter_by.return_value.first.return_value = mock_existing_request
