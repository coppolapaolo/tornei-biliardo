...
class TestProvaServiceAdditional:
    ...
    def test_create_amalfi_round_success(self, mock_db):
        ...
        with patch('models.competition.services.create_amalfi_round_matches') as mock_create:
    ...
    def test_create_amalfi_round_exception_handling(self, mock_db):
        ...
        with patch('models.competition.services.create_amalfi_round_matches') as mock_create:
            ...
            with pytest.raises(ValueError, match="Errore durante la creazione del turno"):
    ...
    def test_reset_trio_success(self, mock_db, mock_match_service):
        ...
        # Verify match reset
        mock_match_service.reset_to_pending.assert_called_once_with(456, clear_validation=True)
