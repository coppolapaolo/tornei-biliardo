...
class TestPlayerOnlyDecorator:
    ...
    def test_player_only_admin_user(self):
        ...
        with patch("utils.current_user") as mock_user, patch(
            "utils.flash"
        ) as mock_flash, patch("utils.redirect") as mock_redirect, patch(
            "utils.url_for"
        ) as mock_url_for:
...
class TestPlayerRequiredDecorator:
    ...
    def test_player_required_not_enrolled(self):
        ...
        with patch("utils.current_user") as mock_user, patch(
            "utils.Inscription"
        ) as mock_inscription, patch("utils.flash") as mock_flash, patch(
            "utils.redirect"
...
class TestMatchPlayerRequiredDecorator:
    ...
    def test_match_player_required_match_not_found(self):
        ...
        with patch("utils.Match") as mock_match, patch("utils.abort") as mock_abort:
...
class TestInscriptionOwnerRequiredDecorator:
    ...
    def test_inscription_owner_required_not_owner(self):
        ...
        with patch("utils.current_user") as mock_user, patch(
            ...
            assert result == "redirect_response"
            mock_flash.assert_called_once_with(
                "Non sei il proprietario di questa iscrizione.", "error"
            )
...
class TestChallengePlayerRequiredDecorator:
    ...
    def test_challenge_player_required_challenge_not_found(self):
        ...
        with patch("utils.Challenge") as mock_challenge, patch(
            "utils.abort"
        ) as mock_abort:
