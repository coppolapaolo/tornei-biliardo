...
class TestExamModel:
    ...
    def test_get_statistics_with_attempts(self, mock_attempts):
        ...
        mock_completed.with_entities.return_value.distinct.return_value.count.return_value = (
            2
        )
...
class TestExamChallengeModel:
    ...
    def test_exam_challenge_creation(self):
        ...
        exam_challenge = ExamChallenge(exam_id=1, challenge_id=2, order=1, weight=1.5)
    ...
    def test_exam_challenge_default_weight(self):
        ...
        exam_challenge = ExamChallenge(exam_id=1, challenge_id=2, order=1)
...
class TestExamAttemptModel:
    ...
    @patch.object(ExamAttempt, "exam")
    def test_complete_exam_with_notes(
    ...
    @patch.object(ExamAttempt, "challenge_results")
    @patch.object(ExamAttempt, "exam")
    def test_complete_exam_without_notes(
        self, mock_exam, mock_challenge_results, mock_datetime
    ):
