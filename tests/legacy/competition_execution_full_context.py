#!/usr/bin/env python3
"""
Script to execute competition routes with full Flask contexts to improve coverage.
"""
...
def execute_competition_routes():
    """Execute competition routes with full Flask contexts."""
    # Create Flask app
        ...
        with app.test_request_context("/"):
            try:
                ...
                with patch(
                    ...
                    "routes.admin.competition.abort"
                ) as mock_abort, patch(
                    "routes.admin.competition.url_for"
                ) as mock_url_for:
                    ...
                    mock_abort.side_effect = Exception("Mocked abort")
