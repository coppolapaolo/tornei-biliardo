...
class TestMatchProposalService:
    ...
    def test_expire_proposals(self, mock_proposal_class, mock_db, mock_datetime):
        ...
        mock_query.filter.return_value.all.return_value = [mock_proposal1, mock_proposal2]
...
class TestIndividualMatchService:
    ...
    def test_create_direct_proposal_success(self, mock_invitation_class, mock_proposal_class, mock_db, mock_timedelta):
    ...
    def test_reject_invitation_success(self, mock_invitation_class, mock_db):
        ...
        mock_invitation = Mock()
        mock_invitation_class.query.filter_by.return_value.first_or_404.return_value = mock_invitation
    ...
    @patch('models.individual_match.services.IndividualMatchService.get_user_availability')
    @patch('models.individual_match.services.IndividualMatchService.get_user_statistics')
    def test_get_user_dashboard_data(self, mock_stats, mock_availability, mock_matches, mock_proposals):
    ...
    def test_get_user_availability(self, mock_availability_class):
        ...
        mock_availability_class.query.filter_by.return_value.all.return_value = [mock_record1, mock_record2]
    ...
    def test_get_user_matches(self, mock_match_class):
        ...
        mock_match_class.query.filter.return_value.order_by.return_value.all.return_value = mock_matches
    ...
    def test_get_user_statistics_complete(self, mock_db):
        ...
        with patch.object(IndividualMatchService, 'get_user_matches') as mock_get_matches:
    ...
    def test_set_player_availability_new(self, mock_db):
        ...
        with patch('models.individual_match.services.PlayerAvailability') as mock_availability_class:
            mock_availability_class.query.filter_by.return_value.first.return_value = None
            mock_availability = Mock()
            mock_availability_class.return_value = mock_availability
            
            result = IndividualMatchService.set_player_availability(123, "Location1", True)
    ...
    def test_get_player_availability(self, mock_availability_class):
        ...
        mock_availability_class.query.filter_by.return_value.all.return_value = mock_records
