...
from models.classification.services import ClassificationService, RoundClassificationService, PlayerEncounterService
...
class TestClassificationService:
    ...
    def test_update_tournament_classification_tournament_not_found(self, mock_bulk_load, mock_db):
    ...
    def test_update_tournament_classification_success(self, mock_get_policy, mock_bulk_load, mock_db, mock_tournament, mock_players):
        ...
        mock_db.session.query.return_value.filter_by.return_value = mock_bulk_load.return_value
        
        # Mock players query
        mock_db.session.query.return_value.filter.return_value.all.return_value = mock_players
        
        # Mock scoring policy
        mock_policy = Mock()
        mock_policy.calculate_standings.return_value = [
            (mock_players[0], {"matches_won": 2, "rack_diff": 5, "provas_played": [1]}),
            (mock_players[1], {"matches_won": 1, "rack_diff": -5, "provas_played": [1]}),
        ]
    ...
    @patch('models.classification.services.bulk_load_relationships')
    @patch('models.classification.services.ClassificationService._get_scoring_policy')
    def test_update_tournament_classification_with_existing_classifications(self, mock_get_policy, mock_bulk_load, mock_db, mock_tournament, mock_players):
        ...
        mock_prova = Mock()
        mock_prova.matches = []  # Empty list instead of Mock object to avoid iteration error
        mock_bulk_load.return_value.all.return_value = [mock_prova]
        ...
        mock_classification_query.filter_by.return_value.all.return_value = [existing_classification]
    ...
    def test_get_tournament_standings(self, mock_db):
        ...
        mock_db.session.query.return_value.filter_by.return_value.options.return_value.order_by.return_value.all.return_value = [mock_classification]
    ...
    def test_get_player_ranking(self, mock_db):
        ...
        mock_classification = Mock()
        mock_db.session.query.return_value.options.return_value.filter_by.return_value.first.return_value = mock_classification
    ...
    def test_get_player_ranking_not_found(self, mock_db):
        ...
        mock_db.session.query.return_value.options.return_value.filter_by.return_value.first.return_value = None
    ...
    def test_get_player_statistics_summary(self, mock_db):
        ...
        with patch.object(ClassificationService, 'get_player_statistics_summary', return_value=mock_result):
    ...
    def test_get_player_progression(self, mock_db):
        ...
        mock_db.session.query.return_value.filter_by.return_value.order_by.return_value.all.return_value = mock_progression
    ...
    @patch('models.classification.services.db')
    @patch('models.classification.models.RoundClassification.calculate_classification_after_round')
    @patch.object(RoundClassificationService, 'get_round_standings')
    def test_calculate_and_save_round_classification(self, mock_get_standings, mock_calculate, mock_db):
        ...
        result = RoundClassificationService.calculate_and_save_round_classification(1, 2)
...
class TestPlayerEncounterService:
    ...
    def test_get_player_encounters(self, mock_db):
        ...
        mock_encounter = Mock()
        mock_db.session.query.return_value.filter.return_value.all.return_value = [mock_encounter]
    ...
    def test_get_encounter_matrix(self, mock_db):
        ...
        mock_db.session.query.return_value.filter_by.return_value.all.return_value = [mock_encounter1, mock_encounter2]
...
class TestClassificationServiceIntegration:
    ...
    def test_classification_service_integration_basic(self, db_session):
        ...
        inscription1 = Inscription(prova_id=prova.id, user_id=user1.id, is_withdrawn=False)
        inscription2 = Inscription(prova_id=prova.id, user_id=user2.id, is_withdrawn=False)
        ...
        player_ranking = ClassificationService.get_player_ranking(tournament.id, user1.id)
