...
class TestIndividualMatchServiceAdditional:
    ...
    def test_get_user_proposals_with_expired(self):
        ...
        with patch(
            ...
            with patch(
                "models.individual_match.services.ProposalInvitation"
            ) as mock_invitation_class:
                with patch(
                    "models.individual_match.services.PlayerAvailability"
                ) as mock_availability_class:
                    with patch(
                        "models.individual_match.services.IndividualMatch"
                    ) as mock_match_class:
                        ...
                        result = IndividualMatchService.get_user_proposals(
    ...
    def test_cancel_proposal_not_pending(self):
        ...
        with patch("models.individual_match.services.db") as mock_db:
            ...
            with pytest.raises(
                ValueError, match="Proposal cannot be cancelled - it's not pending"
            ):
                IndividualMatchService.cancel_proposal(1, 1)
    ...
    def test_submit_rack_result_duplicate_rack(self):
        ...
        with patch("models.individual_match.services.db") as mock_db:
            ...
            with patch(
                "models.individual_match.services.IndividualRack"
            ) as mock_rack_class:
                mock_query = Mock()
    ...
    def test_start_match_user_not_player(self):
        ...
        with patch("models.individual_match.services.db") as mock_db:
            ...
            with pytest.raises(
                ValueError, match="Only match players can start the match"
            ):
    ...
    def test_add_rack_result_user_not_player(self):
        ...
        with patch("models.individual_match.services.db") as mock_db:
            ...
            with pytest.raises(
                ValueError, match="Only match players can add rack results"
            ):
    ...
    def test_complete_match_user_not_player(self):
        ...
        with patch("models.individual_match.services.db") as mock_db:
            ...
            with pytest.raises(
                ValueError, match="Only match players can complete the match"
            ):
    ...
    def test_cancel_match_user_not_player(self):
        ...
        with patch("models.individual_match.services.db") as mock_db:
            ...
            with pytest.raises(
                ValueError, match="Only match players can cancel the match"
            ):
