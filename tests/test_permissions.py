...
class TestBasicPermissions:
    ...
    def test_tournament_filtering_basic(self):
        ...
        assert PermissionChecker.filter_tournaments_by_permission(admin, tournaments, 'view') == tournaments
        assert PermissionChecker.filter_tournaments_by_permission(admin, tournaments, 'manage') == tournaments
        
        # Director should see all for view, none for manage (without DB context)
        assert PermissionChecker.filter_tournaments_by_permission(director, tournaments, 'view') == tournaments
        assert PermissionChecker.filter_tournaments_by_permission(director, tournaments, 'manage') == []
        
        # Player should see all for view, none for manage
        assert PermissionChecker.filter_tournaments_by_permission(player, tournaments, 'view') == tournaments
        assert PermissionChecker.filter_tournaments_by_permission(player, tournaments, 'manage') == []
        
        # Unauthenticated should see all for view, none for manage
        assert PermissionChecker.filter_tournaments_by_permission(None, tournaments, 'view') == tournaments
        assert PermissionChecker.filter_tournaments_by_permission(None, tournaments, 'manage') == []
