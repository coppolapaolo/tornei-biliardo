...
class TestClassificationService:
    ...
    def test_update_tournament_classification_success(self):
        ...
        with patch("models.classification.services.db") as mock_db:
            ...
            with patch("models.classification.services.bulk_load_relationships") as mock_bulk_load:
                ...
                mock_user_filtered_query.all.return_value = [mock_player1, mock_player2, mock_player3]
                
                # Mock scoring policy
                with patch("models.classification.services.ClassicScoringPolicy") as mock_policy_class:
                    mock_policy = Mock()
                    mock_policy.calculate_standings.return_value = [
                        (mock_player1, {"matches_won": 1, "rack_diff": 2, "provas_played": [1]}),
                        (mock_player2, {"matches_won": 1, "rack_diff": 0, "provas_played": [1, 2]}),
                        (mock_player3, {"matches_won": 0, "rack_diff": -2, "provas_played": [2]})
                    ]
                    ...
                    mock_db.session.query.side_effect = [mock_classification_query, mock_user_query, mock_classification_query]
                    mock_classification_query.filter_by.return_value = mock_classification_filtered_query
                    mock_classification_filtered_query.all.return_value = [mock_existing_classification]
    ...
    def test_get_player_statistics_summary_no_standings(self):
        ...
        with patch.object(ClassificationService, 'get_tournament_standings', return_value=[]) as mock_get_standings:
    ...
    def test_invalidate_tournament_cache(self):
        ...
        with patch("models.classification.services.cache_manager") as mock_cache_manager:
    ...
    def test_get_player_statistics_summary_with_standings(self):
        ...
        with patch("models.classification.services.ClassificationService.get_tournament_standings") as mock_get_standings:
    ...
    def test_get_player_statistics_summary_no_standings(self):
        """Test getting player statistics summary with no standings."""
        with patch.object(ClassificationService, 'get_tournament_standings') as mock_get_standings:
...
class TestRoundClassificationService:
    ...
    def test_calculate_and_save_round_classification(self):
        ...
        with patch("models.classification.services.RoundClassification") as mock_round_classification:
            mock_round_classification.calculate_classification_after_round = Mock()
            
            with patch("models.classification.services.RoundClassificationService.get_round_standings") as mock_get_standings:
                ...
                assert result == mock_classifications
                mock_round_classification.calculate_classification_after_round.assert_called_once_with(1, 2)
...
class TestPlayerEncounterService:
    ...
    def test_get_available_opponents_with_available(self):
        ...
        with patch("models.classification.services.PlayerEncounterService.get_encounter_matrix") as mock_get_matrix:
    ...
    def test_record_match_encounters_bye_match(self):
        ...
        with patch("models.classification.services.PlayerEncounter") as mock_player_encounter:
    ...
    def test_get_encounter_statistics_with_encounters(self):
        ...
        with patch("models.classification.services.db") as mock_db:
            ...
            assert result["total_possible_encounters"] == 3  # 3 players can have 3 encounters
