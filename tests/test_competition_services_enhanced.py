...
from models.competition.services import ProvaService, ProvaStateMachine, InscriptionService
...
class TestProvaStateMachineEnhanced:
    ...
    def test_start_playing_insufficient_inscriptions(self, mock_db):
        ...
        with pytest.raises(InvalidTransitionError, match="Numero iscritti insufficiente"):
    ...
    def test_start_playing_inscriptions_exception_handling(self, mock_db):
        ...
        mock_prova.inscriptions = Mock(side_effect=Exception("Relationship not available"))
...
class TestProvaServiceEnhanced:
    ...
    def test_create_prova_without_tournament_or_director(self, mock_prova_class, mock_db):
        """Test create_prova raises error when neither tournament_id nor director_id provided."""
        with pytest.raises(ValueError, match="Una Prova deve avere un tournament_id o un director_id"):
    ...
    def test_modify_inscription_dates_prova_not_found(self, mock_datetime, mock_db, mock_state_machine):
    ...
    @patch('models.competition.services.db')
    @patch('models.competition.services.datetime')
    def test_modify_inscription_dates_cannot_modify(self, mock_datetime, mock_db, mock_state_machine):
    ...
    @patch('models.competition.services.db')
    @patch('models.competition.services.datetime')
    def test_modify_inscription_dates_invalid_range(self, mock_datetime, mock_db, mock_state_machine):
        ...
        with pytest.raises(ValueError, match="La data di inizio deve essere precedente"):
            ProvaService.modify_inscription_dates(
                1,
                datetime(2024, 1, 10),  # Start after end
                datetime(2024, 1, 5)
            )
    ...
    @patch('models.competition.services.db')
    @patch('models.competition.services.datetime')
    def test_modify_inscription_dates_future_start(self, mock_datetime, mock_db, mock_state_machine):
    ...
    @patch('models.competition.services.db')
    @patch('models.competition.services.datetime')
    def test_modify_inscription_dates_current_period(self, mock_datetime, mock_db, mock_state_machine):
    ...
    def test_start_first_round_prova_not_found(self, mock_random, mock_db, mock_start_playing, mock_create_matches):
    ...
    @patch('models.competition.services.db')
    @patch('models.competition.services.random')
    def test_start_first_round_already_started(self, mock_random, mock_db, mock_start_playing, mock_create_matches):
    ...
    @patch('models.competition.services.db')
    @patch('models.competition.services.random')
    def test_start_first_round_insufficient_participants(self, mock_random, mock_db, mock_start_playing, mock_create_matches):
        ...
        mock_db.session.query.return_value.filter_by.return_value.all.return_value = mock_inscriptions
...
class TestInscriptionServiceEnhanced:
    ...
    def test_uninscribe_user_inscription_found(self, mock_db):
        ...
        mock_db.session.query.return_value.filter_by.return_value.first.return_value = mock_inscription
