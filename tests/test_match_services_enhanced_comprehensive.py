...
class TestRackServiceEnhanced:
    ...
    @patch('models.match.services.Rack')
    @patch('models.match.services.db')
    def test_add_rack_with_score_update_match_finished(self, mock_db, mock_rack_class, mock_result_service):
    ...
    def test_set_match_result_direct_best_of_insufficient_score(self, mock_db):
        ...
        with pytest.raises(ValueError, match='uno dei giocatori deve raggiungere 5 punti!'):
    ...
    @patch('models.match.services.Rack')
    @patch('models.match.services.db')
    def test_reset_match_complete_success(self, mock_db, mock_rack_class, mock_match_service):
        ...
        # Verify state reset
        mock_match_service.reset_to_pending.assert_called_once_with(123, clear_validation=True)
        mock_db.session.commit.assert_called_once()
    ...
    @patch('models.match.services.MatchService')
    @patch('models.match.services.db')
    def test_remove_rack_admin_exact_racks_reopen(self, mock_db, mock_match_service, mock_abort):
