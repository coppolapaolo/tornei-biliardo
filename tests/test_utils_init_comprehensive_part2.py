...
class TestRackPlayerRequiredDecorator:
    ...
    def test_rack_player_required_rack_not_found(self):
        ...
        with patch('utils.Rack') as mock_rack, \
...
class TestChallengeAttemptPlayerRequiredDecorator:
    ...
    def test_challenge_attempt_player_required_attempt_not_found(self):
        ...
        with patch('utils.ChallengeAttempt') as mock_attempt, \
             patch('utils.abort') as mock_abort:
    ...
    def test_challenge_attempt_player_required_valid_owner(self):
        ...
        with patch('utils.current_user') as mock_user, \
             patch('utils.ChallengeAttempt') as mock_attempt:
    ...
    def test_challenge_attempt_player_required_not_owner(self):
        ...
        with patch('utils.current_user') as mock_user, \
            ...
            result = test_function(attempt_id=1)
            assert result == "redirect_response"
            mock_flash.assert_called_once_with("Non sei il proprietario di questo tentativo.", "error")
...
class TestIndividualMatchPlayerRequiredDecorator:
    ...
    def test_individual_match_player_required_match_not_found(self):
        ...
        with patch('utils.IndividualMatch') as mock_match, \
             patch('utils.abort') as mock_abort:
    ...
    def test_individual_match_player_required_valid_player(self):
        ...
        with patch('utils.current_user') as mock_user, \
             patch('utils.IndividualMatch') as mock_match:
...
class TestRackManagerRequiredDecorator:
    ...
    def test_rack_manager_required_valid_tournament(self):
        ...
        with patch('utils.Rack') as mock_rack, \
             patch('utils.tournament_manager_required') as mock_tournament_manager:
...
class TestTrioManagerRequiredDecorator:
    ...
    def test_trio_manager_required_valid_tournament(self):
        ...
        with patch('utils.TrioMatch') as mock_trio, \
             patch('utils.tournament_manager_required') as mock_tournament_manager:
...
class TestCalculateRoundClassification:
    ...
    def test_calculate_round_classification_bye_match(self):
        ...
        with patch('utils.Match') as mock_match, \
            ...
            mock_match.query.filter_by.return_value.all.return_value = [mock_match_instance]
    ...
    def test_calculate_round_classification_regular_match(self):
        ...
        with patch('utils.Match') as mock_match, \
            ...
            mock_inscription.query.filter_by.return_value.first.side_effect = [mock_inscription1, mock_inscription2]
...
class TestCreateDefaultUsers:
    ...
    def test_create_default_users(self):
        ...
        with patch('utils.User') as mock_user, \
             patch('utils.db') as mock_db:
...
class TestCreateSampleTournament:
    ...
    def test_create_sample_tournament(self):
        ...
        with patch('utils.Tournament') as mock_tournament, \
             patch('utils.db') as mock_db, \
             patch('utils.ProvaService') as mock_prova_service, \
...
class TestCreateAdminIfNotExists:
    ...
    def test_create_admin_if_not_exists_existing_admin(self):
        ...
        with patch('utils.current_app') as mock_app, \
             patch('utils.User') as mock_user, \
             patch('utils.UserRole') as mock_role:
            ...
            mock_user.query.filter_by.return_value.filter.return_value.first.return_value = mock_existing_admin
    ...
    def test_create_admin_if_not_exists_no_admin(self):
        ...
        with patch('utils.current_app') as mock_app, \
            ...
            # No existing admin
            mock_user.query.filter_by.return_value.filter.return_value.first.return_value = None
