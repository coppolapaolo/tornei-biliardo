...
Due sole, e nessuna delle due esiste in una gara vera: popolare la gara di
giocatori fittizi — nella misura che il pulsante dice: il minimo, fino al
massimo, uno in più — ed eliminare la prova in qualunque stato. Tutto il
resto — aprire le iscrizioni, avviare i turni, segnare i punti — passa dalle
route vere, perché la prova **è** una gara vera con un flag.
