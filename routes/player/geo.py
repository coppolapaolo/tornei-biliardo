...
def api_nearby_gare():
    ...
    for gara in gare:
        ...
        gare_data.append({
            ...
            "province_name": get_province_name(venue.province) if venue and venue.province else None,
            "inscription_end": gara.inscription_end.isoformat() if gara.inscription_end else None,
    ...
    return jsonify({
        ...
        "gare": gare_data,
        "provinces": [
            {"code": p, "name": get_province_name(p)}
